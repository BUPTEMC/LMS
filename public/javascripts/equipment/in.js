function equipment(eid,ename,getequipmentTime,getequipmentReason,member){
  ...
  var name = ename[flag];
  var time = getequipmentTime[flag];
  var reason = getequipmentReason[flag];
  var member = member[flag];
  document.getElementById('input-example-2').value = name;
  document.getElementById('input-example-3').value = time;
  document.getElementById('input-example-5').value = reason;
  document.getElementById('input-example-6').value = member;
}
...
  // 给input  date设置默认值
  ...
  //完成赋值
  document.getElementById('input-example-7').value = today;
}
// 获取人员姓名
