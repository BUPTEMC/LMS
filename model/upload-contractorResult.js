...
module.exports = {
    ...
    uploadPhoto : function(req,dirName,callback){
        ...
        form.parse(req, function(err, fields, files) {
            ...
            var newPath = path.join(__dirname,'../public', dirName, 'contractorResult-img', newName);
            //修改文件的名字
            fs.renameSync(oldPath,newPath);
            var finalPath = path.join('/',dirName,'contractorResult-img',newName).split('\\').join('/');   //将路径中的'\'替换为'/'
